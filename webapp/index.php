      ...
      <div class="container">
        <div class="row">
          <div class="heading text-center col-sm-6 col-sm-offset-3 wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
            ...
            <input id="demo1" type="text" class="col-sm-12 typeahead tt-query my-form-control" placeholder="Type a name of an enzyme..." style="color: white;" autocomplete="off"/>
          </div>
        </div>
      </div>
    </div>        
...
<section id="graphs">
  ...
  <script>
    ...
    $("#demo1").bind('blur keyup',function(e) {  
